...
if __name__ == "__main__":
    ...
    gaussian(highway_path, 1200, 1349, mean_matrix, std_matrix, highway_alpha); 

    mean_matrix, std_matrix = training(fall_path, 1460, 1509, fall_alpha);
    gaussian(fall_path, 1510, 1559, mean_matrix, std_matrix, fall_alpha);   

    mean_matrix, std_matrix = training(traffic_path, 950, 999, traffic_alpha);
    gaussian(traffic_path, 1000, 1049, mean_matrix, std_matrix, traffic_alpha);
